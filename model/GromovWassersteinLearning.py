...
"""
Original code for GromovWassersteinEmbedding and GromovWassersteinLearning
from https://github.com/HongtengXu/s-gwl
"""
...
class GromovWassersteinLearning(object):
    ...
    def __init__(self, hyperpara_dict):
        ...
        self.gwl_model = GromovWassersteinEmbedding(self.src_num, self.tar_num,
                                                    self.dim, self.loss_type)
        self.d_gw = []
